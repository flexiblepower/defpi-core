from . import DropbackInterfaceSendonlyConnectionHandler


class DropbackInterfaceSendonlyConnectionHandlerImpl(DropbackInterfaceSendonlyConnectionHandler):
    """ DropbackInterfaceSendonlyConnectionHandlerImpl
