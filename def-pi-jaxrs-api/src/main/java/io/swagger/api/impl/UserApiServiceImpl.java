...
public class UserApiServiceImpl extends UserApiService {
    @Override
    public Response createUser(SecurityContext securityContext) throws NotFoundException {
        // do some magic!
    ...
    @Override
    public Response listUsers(SecurityContext securityContext) throws NotFoundException {
        // do some magic!
        return Response.ok().entity(new ApiResponseMessage(ApiResponseMessage.OK, "magic!")).build();
    }
}
