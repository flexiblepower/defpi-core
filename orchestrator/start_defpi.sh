...
docker service create --replicas 1 --name orchestrator-ui -e ORCHESTRATOR_URL=http://0.0.0.0:8080/ -p 80:80 def-pi1.sensorlab.tno.nl:5000/defpi/orchestrator-ui
